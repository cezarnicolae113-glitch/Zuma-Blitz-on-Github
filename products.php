...
$products = [
	// Mojo
	array("category" => "mojo", "skuid" => "mojo1", "sku" => "mojo1", "quantity" => "25000", "idolprice" => 10, "hardprice" => 1),
	array("category" => "mojo", "skuid" => "mojo2", "sku" => "mojo2", "quantity" => "100000", "idolprice" => 20, "hardprice" => 2),
	array("category" => "mojo", "skuid" => "mojo3", "sku" => "mojo3", "quantity" => "250000", "idolprice" => 40, "hardprice" => 4),
	array("category" => "mojo", "skuid" => "mojo4", "sku" => "mojo4", "quantity" => "1000000", "idolprice" => 60, "hardprice" => 6),
	array("category" => "mojo", "skuid" => "mojo5", "sku" => "mojo5", "quantity" => "5000000", "idolprice" => 100, "hardprice" => 10),
